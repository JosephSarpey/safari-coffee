...
import { Plus, MapPin, Pencil, Trash2, Loader2, Star } from "lucide-react";
  ...
  return (
    <div className="bg-black pt-6 pb-12 flex-1">
      <div className="flex-1 space-y-8">
        <div className="flex justify-between items-center bg-[#111] p-6 rounded-xl border border-white/10 shadow-lg">
        ...
        {loading ? (
          ...
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-lg animate-in fade-in slide-in-from-bottom-4">
            <h2 className="text-lg font-bold text-white mb-6">Add New Address</h2>
            <AddressForm
          ...
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-lg animate-in fade-in slide-in-from-bottom-4">
            <h2 className="text-lg font-bold text-white mb-6">Edit Address</h2>
            <AddressForm
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {addresses.length === 0 ? (
              <div className="col-span-2 text-center py-12 text-stone-500 bg-[#111] rounded-xl border border-white/5">
              ...
              addresses.map((address) => (
                <div
                  key={address.id}
                  className={cn(
                    "bg-[#111] p-6 rounded-xl border shadow-lg relative group transition-all duration-300",
                    address.isDefault ? "border-[#c49b63]" : "border-white/10 hover:border-white/20"
                  )}
                >
                  {address.isDefault && (
