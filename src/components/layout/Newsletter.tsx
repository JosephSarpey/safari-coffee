...
export default function Newsletter() {
  ...
  // Do not show newsletter on contact or reservation pages if desired, 
  // but for now we follow the user instruction to just move it to footer.
    ...
    <div className="container pb-12 mb-12 border-b border-primary/10">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="space-y-2 text-center md:text-left">
          <h3 className="text-2xl font-black uppercase tracking-widest text-white">Ready to Order?</h3>
          <p className="font-medium text-gray-400">Single-origin Kenya coffee delivered to your doorstep.</p>
        </div>
